...
const upcharges = [
  ...
  {icon:"📝",label:"Full Scripting",desc:"Detailed word-for-word video scripts with delivery coaching — premium add-on"},
];
...
const timeline = [
  ...
  {days:"Week 3",label:"Go Live",desc:"Content starts publishing on schedule. Dashboard goes live. Performance tracking begins."},
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 mb-6 md:mb-8">
          <div className="reveal">
            <div className="solution-card p-6 md:p-8 h-full">
              <h3 className="text-white font-semibold text-lg md:text-xl mb-5 md:mb-6" style={{fontFamily:"var(--font-display)"}}>Included Every Month</h3>
          ...
          <div className="reveal">
            <div className="gradient-border p-6 md:p-8 h-full">
              <h3 className="text-white font-semibold text-lg md:text-xl mb-5 md:mb-6" style={{fontFamily:"var(--font-display)"}}>Getting Started Timeline</h3>
