    ...
    <section className="py-16 md:py-20 relative">
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-10">
        <div className="text-center max-w-2xl mx-auto mb-8 md:mb-10">
          ...
          <h2 className="text-2xl sm:text-4xl md:text-5xl text-white leading-tight tracking-tight mb-4" style={{fontFamily:"var(--font-display)",fontWeight:800}}>
          ...
          <p className="text-slate-400 text-base md:text-xl leading-[1.7]" style={{fontFamily:"var(--font-body)"}}>
            Every platform tracked in one place. Views, engagement, followers, and top-performing content — updated continuously.
          </p>
        </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="space-y-1.5">
                    {platforms.map(p => (
                      <div key={p.name} className="flex items-center gap-3 px-3 py-2.5 rounded-lg" style={{background:"rgba(147,51,234,0.05)",border:"1px solid rgba(147,51,234,0.1)"}}>
                        ...
                        <div className="flex items-center gap-2 flex-1 min-w-0 text-xs text-slate-400" style={{fontFamily:"var(--font-body)"}}>
