...
const pains = [
  ...
  {icon:"⏳",title:"You don't have time to do it right",body:"Running a business is a full-time job. Creating content, scheduling posts, analyzing performance, and staying consistent on top of that — something always gets cut. It's always the marketing."},
  {icon:"📉",title:"Inconsistency kills momentum",body:"Posting once and disappearing for three weeks tells the algorithm and your audience the same thing — you're not serious. Consistency is the only strategy that works, and it requires a system."},
  {icon:"🤷",title:"You don't know what's actually working",body:"Without data, you're guessing what to post, when to post, and who you're talking to. Most businesses post and hope. We post with a strategy and optimize based on what the numbers say."},
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-5">
          ...
          <div className="pain-card p-6 md:p-8 flex flex-col justify-center reveal">
            ...
            <p className="text-slate-400 text-sm md:text-base leading-[1.7]" style={{fontFamily:"var(--font-body)"}}>
              Your audience forgets you exist. Your competitors build trust. The algorithm deprioritizes your account. And rebuilding from zero costs more time than staying consistent ever would have.
            </p>
          </div>
        </div>
